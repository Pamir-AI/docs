...
Next, for Microphone, experiment with the gain setting by changing the value for **Capture**, **Left in** and **Right in**.

For Speaker, turn **Speaker** , **Right Out** and **Left Out**Channel to a volume that you desire.
