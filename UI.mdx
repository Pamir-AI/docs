...
Default password for all web UI is **admin**

> rememver to change your password if you dont want to get hacked :) 
...
<img
  src="/images/UI/web_session_manage.gif"
  alt="Web Session Manage Gi"
  className="mx-auto"
/>