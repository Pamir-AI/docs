...
<iframe width="560" height="315" src="https://www.youtube.com/embed/ivs0Els2_nc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen />
...
Create your Python file with a name ending in `_server.py`. Our main UI will automatically detect and load any MCP server script. [**_(Learn more about MCP here )_**](https://github.com/modelcontextprotocol)
...
3. **What If I Want to Use an Online Model?**
   ...
   We’ve prepared a way to connect with **OpenRouter**, where you can choose from a variety of models to try. Make sure to pick a model that supports **tool calling** and **streaming**. [**_(Learn more here.)_**](https://openrouter.ai/rankings)
